	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active"><a href="manCo.php" class="nav-link">Manage Ingredients</a></li>
...
<script>
  function additem(){
        ...
        <META HTTP-EQUIV="Refresh" CONTENT="0; URL=http://localhost/cpp/logIn.html">
  ...
  <script language="JavaScript">
    function showInput() {
      ...
      <?php
$link = mysqli_connect("localhost", "root", "", "cpp");
